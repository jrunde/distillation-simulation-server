Ext.define('BiofuelsGlobal.view.EconomyPanel', {
            ...
            Ext.Ajax.request({
                ...
                success: function(result){
                    ...
                    var button = Ext.create('Ext.Button', {
                        text: ' ? ',
                        handler: function() {
                            window.open('https://docs.fieldsoffuel.discovery.wisc.edu/economics/');
                        }
                    })
