            ...
            Ext.Ajax.request({
                ...
                success: function(result){
                    ...
                    var button = Ext.create('Ext.Button', {
                        text: ' ? ',
                        handler: function() {
                            window.open('https://docs.fieldsoffuel.discovery.wisc.edu/farm-scores-and-graphs/#environment_graphs');
                        }
                    })
        ...
        series: [
            {
                ...
                tips: {
                    ...
                    layout: 'fit',
                    renderer: function(storeItem, item) {
                        this.setTitle("farm emissions: " + storeItem.get("farm emissions") + " tons CO2e");
                    },
                },
            }, {
                type: 'line',
                ...
                tips: {
                    ...
                    layout: 'fit',
                    renderer: function(storeItem, item) {
                        this.setTitle("average emissions: " + storeItem.get("average emissions") + " tons CO2e");
                    },
                },
            },
        ]
