Ext.define('Biofuels.view.EnergyPanel', {
            ...
            Ext.Ajax.request({
                ...
                success: function(result){
                    ...
                    var button = Ext.create('Ext.Button', {
                        text: ' ? ',
                        handler: function() {
                            window.open('https://docs.fieldsoffuel.discovery.wisc.edu/farm-scores-and-graphs/#energy_graphs');
                        }
                    })
            ...
            series: [
                ...
                },
                {
                  ...
                  tips: {
                    ...
                    layout: 'fit',
                    renderer: function(storeItem, item) {
                      this.setTitle("year: " + storeItem.get("year") + "<br>corn: " + storeItem.get("corn") + " Tons") ;
                    },
                  },
                },
                {
